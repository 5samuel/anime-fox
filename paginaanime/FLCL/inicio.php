...
<!-- Nombre del anime en pantalla-->
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><center><font size="10" face="Algerian">FLCL</font></center></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3" style="width:30%; border-radius: 25px;">
                    <img src="../../img/FLCL.jpg" alt="user" class="img-responsive center-box" style="max-width: 200px;">
                    <br>
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                  ...
                  <!--sipnosis del Anime donde dice aqui-->
                    <p>Naota es un chico normal y corriente de sexto curso que vive con su padre y su abuelo. Su monótona vida en la ciudad de Mabase se ve bruscamente interrumpida cuando una desconocida chica lo atropella con su Vespa. Su vida se convertirá en una auténtica locura cuando comiencen a salirle robots de la cabeza y deba luchar para salvar la Tierra.<center>
                        <!-- Datos del Anime-->

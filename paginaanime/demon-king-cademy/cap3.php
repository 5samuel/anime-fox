                ...
                <li><a href="../../inicio.html"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Inicio</a></li>
                    <li>
                        ...
                        <li><a href="../mortal/inicio.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp; Mortal</a></li>
                            <li><a href="esperacienciaficción.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp; Horimilla </a></li>
                            <li><a href="esperacomedia.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp; No game no life </a></li>
                            <li><a href="esperafantasía.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp; Tatoeba</a></li>
                            <li><a href="esperamelodrama.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp; Smarphone</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><center><font size="10" face="Algerian">Demon king Academy cqpitulo 3</font></center></h1>
            </div>
        </div>
...
<div style="position:relative;height:0;padding-bottom:56.6%"><iframe src="https://streamium.xyz/gocdn.html#TmQ5c1pkNThyK0VxSXM5b2hDQWF4Mll5SExhbHlNRlRTWmNUOERRclBYRjFISVpFT2FOSnB0WmRTVkhpSHdEeWZXVzlFSmlyTmhhMXVXSzdKNndCRHhhd2VIWXpVT3BDaGhabUxUTXQyQzhFRmJsT2VKdFVWYXByVjBzSmhXdEE" controls style="position:absolute;width:97%;height:100%;left:0" width="500" height="360" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>

</div>
</div>
<a href="cap2.php"><button style="float-right:30px;">Anterior</button></a>
<a href="cap4.php"><button style="float-right:30px;">Siguiente</button></a>
<a href="inicio.php"><button style="float-right:30px;">capitulos</button></a>
        ...
        <footer class="footer full-reset">
            ...
            <div class="footer-copyright full-reset all-tittles">comentarios</div>
        </footer>
        <div id="fb-root"></div>

    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><center><font size="10" face="Algerian">Akame ga kill</font></center></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3" style="width:30%; border-radius: 25px;">
                    <img src="../../img/akame.jpg" alt="user" class="img-responsive center-box" style="max-width: 300px;">
                    <br>
                    <div class="estado"><center><h4>Finalizado</h4></center></div> <div class="imagen"><img src="../../img/megusta.png" alt=""></div>
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                   <h2>sipnosis</h2>
                    <p>Akame ga Kill! es un manga japonés escrito por Takahiro e ilustrado por Tetsuya Tashiro, que se publica mensualmente en la Gangan Joker de Square Enix desde el 20 de agosto de 2010.
<center>
<h3>Título original: Akame ga kill</h3>
<h3>Año:2011</h3>
<h3>País:Japon</h3>
